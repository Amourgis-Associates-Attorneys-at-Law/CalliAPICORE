...
# Notes to self
Publish using 
msbuild CalliAPI.csproj /t:Publish /p:PublishProfile=PSDProgramsRelease /p:Configuration=Release /p:NoWarn=true /v:normal > publish.log
...
Now CalliAPI has a more permanent home inside the SharePoint with a custom-made index page for installing from!
